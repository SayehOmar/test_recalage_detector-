...
def process_lines(
    ...
    if fibro_line.empty or old_fibro_line.empty or new_cadaster.empty or old_cadaster.empty:
        print("Warning: One or more input GeoDataFrames are empty.")
        return None  # Prevents errors in main.py
